...
> **COUNTER-ARGUMENT PREP (added 7/13 — Will predicts Dan argues "bigger is safer, up to $1M"):**
> **Concede what's true:** Dan is right about *business* risk — a $700K–$1M firm has staff depth, diversified clients, cleaner books, absolute-dollar DSCR cushion; micro-deals carry maximal key-man risk. Don't fight that; it's correct.
> **The distinction that wins:** business risk ≠ balance-sheet risk. Dan is optimizing P(failure); Will's principles optimize *consequence* of failure. A $1M deal that fails takes SBA personal-guarantee money and years; a $250K deal that fails costs fund capital rebuilt in 24 months of autos. You can't compound from ruin — and first-timers get exactly one balance sheet. Max leverage at max inexperience is the riskiest combination available *for us*, even when the asset itself is safer.
> **The empirical trump card:** the big-first path has a 14-month track record — it froze Will completely (Apr 2025 → 0 outreach). A "safer" deal that never gets executed has a 100% failure rate. Deal #1's job is to convert us from inexperienced to experienced at a price that can't hurt us; deal #2 (Dan's size, WITH Dan) is the same destination, sequenced.
> **The honest negotiable:** the $300K line is a proxy; the HARD constraints are ~$50K cash-in cap, DSCR ≥2.0×, no house money, and PG exposure that passes the freeze test. If Dan's outside-capital raise + a large standby seller note structure a bigger deal that passes those, LISTEN — that's principles holding, not caving.
> **The fair counter-question for Dan:** "Who signs the personal guarantee?" If Dan isn't signing PG or writing a check, he's advocating risk he doesn't carry. Said warmly, once.
