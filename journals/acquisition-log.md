...
Running deal flow log. Append entries via `/acquisition log-deal`. Do not clear — reviewed weekly via `/acquisition weekly-review`.
...
Action taken: [evaluated only / contacted broker / requested IM / submitted LOI]
```
...
- Other ideas considered but deprioritized: media buying/lead gen, e-commerce, AI trading community
...
- Arizona CPA law confirmed: non-CPA can't hold 51%+ ownership. Paths: Dan pursues CPA, retain CPA equity partners, or avoid CPA-only services/name
