...
*Cleared May 31, 2026 reflection. Prior captures resolved: 5/28 pregnancy possibility — symptom cluster reads weaker after smell episode confirmed as single-evening (not persistent); test-plan close-the-loop carried in dashboard #9, deferred to Will + Elena's call on timing. Carry from 5/25 still open: GCal + Gmail connectors; populate coach stubs (gottman, schnarch, evans, hormozi) — not surfaced this reflection.*

---

**2026-06-01 — SoCal trip Jun 19–21 plan LOCKED (Reggie end-time/studio pending)**
Father's Day weekend, drive trip with Elena + Koda.

- **Lodging:** Airbnb, **Sunset Beach** (HB-adjacent, dog-friendly culture, fewer STR-rule risks than HB proper). Value tier, dog-friendly, full kitchen (cut-adherence), Superhost 4.85+, self check-in, free parking, fenced yard preferred. Book Wed.
- **PTO:** Friday only.
- **Fri Jun 19:** Ravage at home 7–8:30a → depart Chandler 9:30a → stops Blythe/Chiriaco + Banning → arrive Sunset Beach ~4p → settle Koda → pier/beach walk → low-key dinner near rental.
- **Sat Jun 20 (active recovery, no lift):** Huntington Dog Beach + pier AM (covers 12.5k steps + Zone 2 naturally) → lunch → buffer → **Reggie dance lesson 4pm+** (Elena coordinating directly) → nice dinner reservation near Reggie's studio (post-lesson, date-night anchor).
- **Sun Jun 21:** brunch with Lantu in HB ~10–11a → on road by 12:30p → stops → home Chandler ~7p.
- **Wed Jun 3 booking checklist:** (1) Airbnb in Sunset Beach, (2) Saturday dinner reservation near Reggie's studio, (3) confirm Reggie slot end-time + studio location with Elena before #2.
- **Open variables:** Reggie's exact end time + studio location (gates the dinner reservation area).
...
- **Reggie rates (reference only — lesson ALREADY PAID, separate from trip budget):** 1 session $160 · 2+ $155 ea · 4+ $150 ea. Outcall (+$65, up to 25 mi) was an option, not taken — session is in-studio at 5235 Pacific.
- **Allergy note:** Reggie's household has 2 cats + a dog. In-studio session means brief exposure — pack antihistamine if either Will or Elena is cat-sensitive. Not a budget item.
- **Budget CONFIRMED clean:** $600 all-in covers gas + lodging + food ONLY. Lesson is sunk/prepaid, outside the $600. Math closes comfortably: gas ~$110 + lodging $260–360 + meals leaves healthy cushion. Saturday Bixby Knolls date-night dinner is back ON.
