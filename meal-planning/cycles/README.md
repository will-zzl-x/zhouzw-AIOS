...
## CURRENT CYCLE → [`2026-08-05.yaml`](2026-08-05.yaml) · [cook plan](2026-08-05-cook-plan.md)

## All cycles (newest first)

| Cycle | Files | One-liner |
|---|---|---|
| **2026-08-05** (CURRENT) | `2026-08-05.yaml`, `-cook-plan.md` | Ad hoc, Wed 8/5→Tue 8/11 (post-NYC return through business trip). Cooks spread across the week, not one weekend session: curry + rotisserie Wed, burritos (+ marinate teriyaki/prep kimchi ahead) Thu, teriyaki Fri, mac & cheese + fried rice + sweet potato fries Sat. Maintenance-phase macro fill (rice bumps + watermelon/blueberries/sweet-potato-fries fillers) closes the calorie/carb gap to ~1%. |
| 2026-07-25 | `archive/2026-07-25.yaml`, `-cook-plan.md` | SHORT pre-NYC fridge-clear (Sat 7/25→Wed 7/29; fly Thu 7/30). Cook-almost-nothing-new, ~$0 grocery. Steak & salad, crispy chicken sandwich (#5), chicken parm, spaghetti-squash bolognese, egg bake + hot dog. Planned off a 7/24 photo audit; note-only cooks; deplete AFTER NYC. |
