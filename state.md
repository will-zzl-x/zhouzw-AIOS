...
- **Banff trip Jul 2–12** — Will P1 only (7/2-7/7). PHX→YYC flight + Moraine shuttle still need booking THIS week. Inbox 2026-06-13.
  ...
  - **Late arrivals Jul 7→8 land midnight YYC.** Customs/baggage means desk arrival ~1:30–2 AM — past every rental desk close (Hertz/Avis ~1 AM latest, Enterprise/Budget midnight, Alamo 11:59 PM). **Plan:** 1-day Hertz YYC rental (Jul 8 only, ~$120–225 USD), pre-arrange after-hours pickup via 403-221-1676 BEFORE the trip (confirmation number + rep name). Late arrivals drive themselves to Canmore (~3 AM arrival), use car all day Sunday Jul 8 in Canmore, then a non-renting P1 person drives the car back to YYC Sunday evening on departure run. Backup if Hertz falls through: private transfer YYC→Canmore (Airport Shuttle Express 24/7, ~CAD $270–400 for 2–4 pax). Enterprise Canmore is CLOSED SUNDAYS — local rental backup blocked Sun 7/8.
