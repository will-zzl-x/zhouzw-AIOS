...
- **Location criteria (7/12, final set):** sunny + moderate (no AZ extremes/dryness, not gray-rainy) · **strong bachata sensual scene** (quest-infrastructure — dance is a standing desire-polarity move) · **closer to Northwest Arkansas where possible**. **Dallas is the runaway leader** (top-tier bachata scene, 0% tax, ops market, ~2h to PHX, ~5h drive / 1h flight to XNA). KC = dark horse only if NWA proximity dominates; Houston/Austin have the scene but worse logistics; Chicago + Southeast dropped. 2027 scouting weekends confirm.
