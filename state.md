...
- **BJJ trial: still unbooked, 2 weeks open.** The Life-main-quest keystone is currently a value statement, not a habit. Carry-forward priority next week.
...
- **Solo-pursuit keystone LOCKED but not active: Friday 7 AM No-Gi BJJ (Flow MMA), 1×/wk.** The Life main quest. Two weeks unbooked — book trial + run session 1 next week.
