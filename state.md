...
- **Class #1 × Sedona conflict: CLEARED (Will, 7/19)** — sessions don't collide with the trip; register normally.
...
- **Eval reps: 9 of 12+ logged (7/23).** Target of 3–4 before Friday's meeting well exceeded — 9 real listings run (4 NO, incl. 2 Tucson leads geo-disqualified after Will confirmed Phoenix-metro-only, 5 CONDITIONAL). Two live Phoenix-metro standouts pending seller SDE: East Valley EA practice ($206k disclosed SDE), Gilbert tax/accounting ($160k price / $267k revenue). See `journals/acquisition-log.md`. Next 3 by Aug 31, Saturday keystone + weekday slots.
...
- **Digital declutter DESIGNED + DECIDED 7/19 (`digital-declutter` backlog row):** Instagram deleted 30 days with Elena holding the Screen Time passcode; YouTube kept but disciplined (off home screen, intentional-access-only, no feed — Will's call to keep passive/learning use). Starts this week after the promo doc ships. Guardrail flagged: "learning video" is the binge rationalization — the line is chose-the-video vs. algorithm-served-the-next-one.
